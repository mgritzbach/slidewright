...
function windowsProcessTree(rootPid) {
  const script = [
    ...
    "    if ($ids.Contains([uint32]$process.ParentProcessId) -and -not $ids.Contains([uint32]$process.ProcessId) -and $parent -and $process.CreationDate -ge $parent.CreationDate) {",
