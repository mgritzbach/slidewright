...
- Each box is anchored to a named target shape and carries a concise partner-level check.
- Findings cover human judgment such as evidence validity, takeaway clarity, decision relevance, density, and storyline logic.
