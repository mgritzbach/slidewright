...
For real-world acceptance, use the five-scenario [v0.4.0 manual test plan](docs/MANUAL_TEST_PLAN_0.4.0.md). It captures first-open acceptance, editability, save/close/reopen stability, reference recognizability, source-native inheritance, E6 specificity, cleanup minutes, and screenshots by slide number. The [v0.4.0 release notes](docs/RELEASE_NOTES_0.4.0.md) distinguish completed product capabilities from the external C02, C13, and C19 evidence gates that deliberately remain open.
