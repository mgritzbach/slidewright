...
- The direct PowerPoint adapter is an optional Windows-only fallback proven for one named native text/bold edit inside one native group. It does not establish broad fine-grained editing, chart mutation, arbitrary selection flows, or C16.
